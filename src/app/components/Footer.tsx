...
export function Footer() {
  const companyInfo = {
    email: import.meta.env.VITE_COMPANY_EMAIL || 'rbsglobalventures@gmail.com',
    phone: import.meta.env.VITE_COMPANY_PHONE || '8681971471',
    address: import.meta.env.VITE_COMPANY_ADDRESS || 'Royal Complex, Door No. 8G8, ST-8, Thisaikaval North Street, Arumuganeri - 628202, Tuticorin District, Tamil Nadu, India',
    gstin: import.meta.env.VITE_COMPANY_GSTIN || '33DWVPB8302Q1ZY'
  };
  return (
